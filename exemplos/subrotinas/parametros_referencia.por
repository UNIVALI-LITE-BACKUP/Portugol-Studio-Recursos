...
programa
{
	...
	// Exibe os valores contidos no vetor. Neste caso, o vetor é 
	// passado por valor
	funcao exibe (inteiro v[]) 
	{
		para(inteiro i = 0; i < 10; i++)
		{
			...
			// o valor permanece o mesmo, pois o vetor foi passado por valor
			v[i] = 5 
		}
	}

	// Ordena o vetor em ordem crescente. Neste caso, o vetor é
	// passado por referência
	...
	// Troca os valores de duas posições do vetor. Neste caso,
